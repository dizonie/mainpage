...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to handle smooth scrolling with custom animation
    function smoothScroll(target, isInitialLoad = false) {
        ...
        if (targetElement) {
            ...
            // Don't animate on initial load if at the top of the page
    ...
    // Handle direct hash URLs on page load - only if not at top of page
